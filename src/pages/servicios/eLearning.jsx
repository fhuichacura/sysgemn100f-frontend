// src/pages/servicios/eLearning.jsx
...
export default function ELearning() {
  ...
  const [clientes, setClientes] = useState([
    {
      ...
      contrato: "Suscripción Mensual",
      licencia: "ELEARN-XYZ12345",
      estado: "Activo",
      inicio: "2024-01-10",
      fin: "2024-12-10",
    },
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const licencia = `ELEARN-${crypto.randomUUID().slice(0, 8).toUpperCase()}`;
    setClientes([
      ...clientes,
      {
  ...
  return (
    <div className="text-white">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold">Clientes con eLearning</h2>
        <button
      ...
      {showModal && (
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-zinc-800 p-6 rounded-xl w-[500px] border border-gray-700">
            <h3 className="text-xl font-semibold mb-4">Registrar cliente con eLearning</h3>
