// src/pages/servicios/TemplatesWeb.jsx
import { useState } from "react";
import { PlusCircle } from "lucide-react";

export default function TemplatesWeb() {
  const [showModal, setShowModal] = useState(false);
  const [clientes, setClientes] = useState([
    {
      empresa: "Agencia XYZ",
      contrato: "One-Time Setup",
      licencia: "TPLWEB-XYZ12345",
      estado: "Activo",
      inicio: "2024-02-10",
      fin: "2024-12-31",
    },
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const licencia = `TPLWEB-${crypto.randomUUID().slice(0, 8).toUpperCase()}`;
    setClientes([
      ...clientes,
      {
    ...
    setShowModal(false);
    setForm({ empresa: "", contrato: "One-Time Setup", inicio: "", fin: "" });
  };

  return (
    <div className="text-white">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold">Clientes con Templates Web</h2>
        <button
      ...
      {showModal && (
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-zinc-800 p-6 rounded-xl w-[500px] border border-gray-700">
            <h3 className="text-xl font-semibold mb-4">Registrar cliente con Templates Web</h3>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option>Licencia Extendida</option>
                </select>
              </div>
