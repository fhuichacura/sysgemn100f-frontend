...
import { generarLicencia } from "../../utils/licencias";
...
export default function Numina() {
  ...
  const [clientes, setClientes] = useState([
    {
      ...
      contrato: "Licencia Anual",
      licencia: "NUMINA-ABCD1234",
      estado: "Activo",
      inicio: "2024-03-01",
      fin: "2025-03-01",
    },
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const nueva = generarLicencia("NUMINA", form.empresa); // 👈 genera objeto
    setClientes((prev) => [
      ...prev,
      {
        empresa: form.empresa,
        contrato: form.contrato,
        licencia: nueva.codigo, // ✅ solo usamos el string
        estado: "Activo",
        inicio: form.inicio,
        fin: form.fin,
      },
    ...
    setShowModal(false);
    setForm({ empresa: "", contrato: "Licencia Básica", inicio: "", fin: "" });
  };

  return (
    <div className="text-white">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold">Clientes con Númina</h2>
        <button
      ...
      {showModal && (
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-zinc-800 p-6 rounded-xl w-[500px] border border-gray-700">
            <h3 className="text-xl font-semibold mb-4">Registrar cliente con Númina</h3>
